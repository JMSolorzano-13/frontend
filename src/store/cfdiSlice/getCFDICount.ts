...
export const getCFDICount = createAsyncThunk<Out, In, { rejectValue: string; state: RootState }>(
  "cfdi/getCFDICount",
  async ({ options, module, validationId, cfdiType }, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      let cfdiCount: CFDICount | null = null;
      ...
      console.error("Unexpected error in CFDICount: ", e);
      return rejectWithValue("Error al obtener el conteo de CFDI");
    }
  }
);
