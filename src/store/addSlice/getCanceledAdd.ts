...
export const getCanceledADD = createAsyncThunk<
  Out,
  In,
  ...
  async (
    ...
    try {
      ...
      const availableRules: Domain = [
        ['add_exists', '=', true],
        ['add_cancel_date', '!=', null], // Sólo contamos los que están cancelados, quitar este filtro contbabilizará los vigentes y cancelados en el ADD
      ]
